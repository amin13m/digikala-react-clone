            ...
            <table className="min-w-full text-left border-collapse border-b border-2 border-gray-300  dark:border-gray-700">
              <thead>
                <tr className="bg-gray-300  dark:bg-gray-700">
                  <th className="px-3 py-1 text-sm  dark:text-gray-200">
                    محصول
                  </th>
                  <th className="px-3 py-1 text-sm dark:text-gray-200">
                    تعداد
              ...
              <tbody>
                {order.items.map((item, index) => (
                  <tr
                    key={index}
                    className="border-b border-2 border-gray-300  dark:border-gray-700"
                  >
                    <td
                      className="px-3 py-1 text-sm dark:text-gray-200"
